...
# CSS  para agrandar el ícono del toolbar
st.markdown("""
<style>
/*
...
with st.sidebar:
    ...
    st.caption(
        f"Costo por hora de penalización: ${COSTO_POR_HORA_FIJO:.2f} USD")
    ...
    status_placeholder.warning(
        "Configuración lista. Presione 'Iniciar' para correr el modelo.")
...
log_container.write(
    "10:04 AM - ASIGNACIÓN (Política: Prioridad por Conf.): C-101 -> Línea 1.")
log_container.write("10:07 AM - FALLA: Línea 2 sin documentos (Falla Admin).")
log_container.write(
    "10:08 AM - DEVOLUCIÓN: Contenedor C-102 devuelto al patio.")
